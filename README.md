...
Hands-on engineering manager, Java and Spring, with production experience in RAG pipelines, agentic systems, and LLM integration.

**Currently:** getting current on Spring Boot 3, Spring Data JPA and Hibernate, built from raw JDBC up one layer at a time. A public Java project follows.
